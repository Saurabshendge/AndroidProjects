        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData == true)
                    Toast.makeText(MainActivity.this, "Existing Entry Updated", Toast.LENGTH_LONG).show();
                else
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData == true)
                    Toast.makeText(MainActivity.this, "Employee Removed", Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(MainActivity.this, "No Employee Removed", Toast.LENGTH_LONG).show();
            }
        });
